...
const getters = {
  ...
  detailMails: state=>state.data && state.data.mails? state.data.mails : [],
  detailDocuments: state=>state.data ? state.data.project_file : [],
  ...
  detailInventorBonus: state=>state.data && state.data.fees.inventor_bonus ? state.data.fees.inventor_bonus : '',
