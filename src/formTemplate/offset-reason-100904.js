...
<div class="custom-checkbox">
    ...
    <el-checkbox @change="change('amendment_reason_article66')" v-model="extendData.amendment_reason_article66" label="amendment_reason_article66">
...
const options = {
    data: {
        extendData: {
            ...
            amendment_reason_article66: false,
        ...
        checked: "",
        checkboxKey: ["amendment_reason_article60", "amendment_reason_article66", "amendment_reason_notice"],
    },
    methods: {
        change: handleSingle,
    },
