const map = new Map([
	...
	['task', [
        ...
        { type: 'static_select',    id: 'category',               name: '案件类型',      map_type: 'category'},
        ...
        { type: 'remote_select',    id: 'assistant',             name: '代理人助理',     data_key: 'data',          url: '/users'},
        { type: 'remote_select',    id: 'first_reviewer',         name: '初审核人',       data_key: 'data',          url: '/users'},
        { type: 'remote_select',    id: 'final_reviewer',         name: '复审人',         data_key: 'data',          url: '/users'},
        { type: 'remote_select',    id: 'ipr',                   name: 'IPR',           data_key: 'data',          url: '/users'},
    ...
    ['patent', [
        ...
        { type: 'remote_select',    id: 'assistant',                 name: '代理人助理',         url: '/users',data_key: 'members'}, 
        { type: 'remote_select',    id: 'contact',                 name: '联系人',         url: '/users',data_key: 'members'}, 
        { type: 'remote_select',    id: 'first_reviewer',                 name: '初审人',         url: '/users',data_key: 'members'}, 
        { type: 'remote_select',    id: 'final_reviewer',                 name: '复审人',         url: '/users',data_key: 'members'}, 
        { type: 'remote_select',    id: 'representative',                 name: '代表人',         url: '/users',data_key: 'members'}, 
        { type: 'remote_select',    id: 'consultant',                 name: '顾问',         url: '/users',data_key: 'members'}, 
        { type: 'remote_select',    id: 'sales',                 name: '销售',         url: '/users',data_key: 'members'}, 
