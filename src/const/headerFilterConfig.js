...
const map = new Map([
  ...
  [
    ...
    [{
      ...
      {
        type: "date",
        id: "pct_application_date",
        name: "国际申请日"
      },
      {
        type: "date",
        id: "pct19_expire_date",
        name: "PCT19条修改期限"
      },
      {
        type: "date",
      ...
      {
        type: "text",
        id: "pct_application_number",
        name: "国际申请号"
      },
      {
        type: "date",
        id: "pct_priority_date",
        name: "国际优先权日"
      },
      {
        type: "date",
        id: "pct_publication_date",
        name: "国际公开日"
      },
      {
        type: "static_select",
  ...
  [
    ...
    [{
      ...
      {
        type: "text",
        id: "project.application_number",
        name: "申请号"
      },
      {
        type: "date",
        id: "project.application_date",
        name: "申请日"
      },
      /*{
        type: "remote_select",
  ...
  [
    ...
    [{
      ...
      },
      {
        ...
        id: "status",
        name: "请款单状态",
        map_type: "invoice_status"
      },
      {
        type: "static_select",
        id: "is_voucher_uploaded",
        name: "票据已上传",
        map_type: "bool"
      },
      {
