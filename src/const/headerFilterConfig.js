const map = new Map([
	...
	['task', [
        ...
        { type: 'static_select',    id: 'project_tags',          name: '案件标签',       map_type: 'tags', url: '/tags?listOnly=1'},
        { type: 'static_select',    id: 'process_tags',          name: '事项标签',      map_type: 'tags', url: '/tags?listOnly=1'},
        ...
        { type: 'static_select',    id: 'process_action',                 name: '当前节点',      map_type: 'actions',},
    ...
    ['patent', [
        ...
        { type: 'remote_select',    id: 'assistant',                 name: '代理人助理',         url: '/users',data_key: 'data'}, 
        { type: 'remote_select',    id: 'contact',                 name: '联系人',         url: '/users',data_key: 'data'}, 
