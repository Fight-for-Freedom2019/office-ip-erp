const map = new Map([
	['task', [
        ...
        { type: 'static_select',    id: 'processDefinition',     name: '管制事项',      map_type: 'task_def'},
        { type: 'static_select',    id: 'processFlow',           name: '当前节点',      map_type: 'flow_node',     url: '/flownodes'},
        ...
        { type: 'remote_select',    id: 'firstReviewer',         name: '初审核人',       data_key: 'data',          url: '/customers'},
        { type: 'remote_select',    id: 'finalReviewer',         name: '复审人',         data_key: 'data',          url: '/customers'},
