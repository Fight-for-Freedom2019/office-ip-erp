...
const map = new Map([
    ['task', [
       ...
       { components: 'static_select',         id: 'process_action',                          name: '当前节点', type: 'actions', used: true},
       { components: 'static_select',         id: 'process_stage',                          name: '当前阶段', type: 'processs_stage'},
       { components: 'remote_select',         id: 'user',                          name: '承办人', type: 'user'},
       { components: 'remote_select',         id: 'agent',                          name: '代理人', type: 'user', used: true},
       { components: 'remote_select',         id: 'first_reviewer',                          name: '初审人', type: 'user'},
       { components: 'remote_select',         id: 'final_reviewer',                          name: '复审人', type: 'user'},
       { components: 'remote_select',         id: 'representative',                          name: '对外代理人', type: 'user'},
       { components: 'static_select',         id: 'organization_unit',                          name: '所属部门', type: 'branch', used: true},
       ...
       { components: 'remote_select',         id: 'customer',                          name: '客户', type: 'customer'},
       { components: 'static_select',         id: 'ipr',                          name: 'IPR', type: 'ipr_para'},
       { components: 'remote_select',         id: 'contact',                          name: '联系人', type: 'user'},
       ...
       { components: 'date',         id: 'internal_final_edition_time',                          name: '内部定稿日',},
       { components: 'date',         id: 'customer_edition_time',                          name: '返稿日',},
       { components: 'date',         id: 'customer_final_edition_time',                          name: '客户定稿日',},
       ...
       { components: 'input',        id: 'internal_reviewing_period',                          name: '内审时长',},
       { components: 'input',        id: 'customer_first_edition_period',                          name: '返稿时长',},
       { components: 'input',        id: 'customer_reviewing_period',                          name: '客审时长',},
    ...
    ['patent', [
        ...
        { components: 'static_select', id: 'subtype',                          name: '案件类型', type: 'patent_type_strainer', used: true},
        { components: 'static_select', id: 'area',                           name: '申请地区', type: 'area', used: true},
        ...
        { components: 'date',          id: 'publication_date',                    name: '公开日', used: true},
        ...
        // { components: 'static_select', id: 'tags',                           name: '标签', type: 'tag'},
        { components: 'static_select', id: 'organization_unit',                         name: '部门', type: 'branch'},
        { components: 'static_select', id: 'classification',                 name: '技术分类', type: 'classification'},
        ...
        { components: 'static_select', id: 'ipr',                            name: '负责IPR', type: 'ipr_para',},
        ...
        { components: 'remote_select', id: 'representative',                          name: '代表人', type: 'user'}, //代理人
        { components: 'remote_select', id: 'consultant',                          name: '顾问', type: 'user'}, //代理人
        ...
        { components: 'static_select', id: 'pct_publication_language',              name: '国际公开语言', type: 'language'},
    ...
    ['points',[
        { components: 'static_select', id: 'project_type',            name: '案件类型', type: 'project_type', used: true},
        { components: 'static_select', id: 'subtype',                 name: '案件子类型', type: 'subtype', used: true},
        { components: 'static_select', id: 'process',      name: '管制事项', type: 'process_definition', used: true },
        ...
        { components: 'static_select', id: 'status',                  name: '状态',     type:"bonus_status",used:true},
