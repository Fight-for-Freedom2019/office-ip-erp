      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="申请人类型" prop="applicant_type">
			...
			<el-row>
				<el-col :span="8">
					<el-form-item label="申请人地区" prop="district">
						<static-select v-model="form.district" type="area"></static-select>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="申请人城市" prop="city">
						<city v-model="form.province_city" @input="chooseAddress"></city>
					</el-form-item>
				</el-col>
				<el-col :span="8">
