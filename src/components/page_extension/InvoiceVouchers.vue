        ...
        data() {
            return {
                tableOption: {
                    ...
                    'columns': [
                        // {type: 'selection'},
                        {type: 'text', label: '发票号', prop: 'serial', width: '120'},
                        {type: 'text', label: '客户/供应商', prop: 'customer', width: '150',render_simple:"name"},
                        // {type: 'text', label: '关联账单', prop: 'invoice',render_simple:"serial", width: '120',render_header:true},
                        {type: 'text', label: '发票抬头', prop: 'invoice_target',render_simple:"name", min_width: '150'},
                        {type: 'text', label: '金额', prop: 'amount', width: '100'},
                        {type: 'text', label: '状态', prop: 'status',render_simple:"name", min_width: '120'},
                        {type: 'text', label: '税务票号', prop: 'tax_no', min_width: '120'},
                        {type: 'text', label: '备注', prop: 'remark', width: '120'},
                    ],
                },
