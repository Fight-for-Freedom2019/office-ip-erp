...
<template>
    <app-shrink :visible.sync="dialogVisible" :modal='false' :title="title" ref="top">
        <span slot="header" style="float: right;">
            <el-button type="primary" v-if="mode === 'add'" size="small"
                        @click="save('add')">申请开票</el-button>
            <el-button type="primary" v-if="mode === 'edit'" size="small"
                ...
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="账单" prop="invoice">
                            <jump-select type="bill" :para="para" v-model="form.invoice" :disabled="this.mode === 'edit'"></jump-select>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                tableOption: {
                    ...
                    'columns': [
                        ...
                        {type: 'text', label: '代理费', prop: 'service_fee.sum', width: '100',},
                        {type: 'text', label: '官费', prop: 'official_fee.sum', width: '100',},
        ...
        methods: {
            save() {   // type是父组件传来的,表示是add还是edit,id表示修改的某一行数据的id
