    ...
    <app-shrink :visible.sync="dialogVisible" :modal='false' :title="title">
            <span slot="header" style="float: right;">
              ...
              <el-dropdown size="small" v-if="showSendMailBtn" @command="sendmail">
                <el-button type="primary" size="small">发送邮件<i class="el-icon-arrow-down el-icon--right"></i></el-button>
      ...
      <div v-loading="loadingVisible" :element-loading-text="loadingText">
        <el-form label-width="75px" ref="form" v-model="form" label-position="left" class="form-information">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="6">
              <el-form-item label="支付金额" v-if="mode==='pay'"><span
                  class="form-item-text">{{form.received_amount}}</span>
              </el-form-item>
        ...
        <div class="PaymentRequestDetail">
          <el-tabs v-model="activeName">
            ...
            <el-tab-pane label="回款记录" name="received_payments" v-else>
              <received-record ref="receivedPayments" :id="id" :data="receivedData" :invoice="invoice"
                               @received="received"></received-record>
            </el-tab-pane>
