<template>
  <el-dialog :title="title" :visible.sync="dialogVisible" :modal="false" class="dialog-small">
  	<el-form label-width="100px" ref="form" :model="form" :rules="rules">
  		...
  		<el-form-item label="发明人类型" prop="type">
  			<static-select type="applicant_type" v-model="form.type"></static-select>
  		</el-form-item>
      <el-form-item label="国籍" prop="postcode">
      ...
      <el-form-item label="英文姓" prop="address">
      ...
      <el-form-item  label="">
          <el-checkbox v-model="form.is_default">是否公开姓名</el-checkbox>
        </el-form-item>
