    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          // { type: 'expand' },
          { type: 'selection' },
          { type: 'text', prop: 'model', label: '模块', render_header: true, render_simple: 'name', width: '80',},
          { type: 'text', prop: 'serial', label: '案号', render_header: true, width: '160',},
          { type: 'text', prop: 'title', label: '标题', render_header: true, width: '200'},
          { type: 'array', prop: 'project_tags', label: '案件标签', render: this.tagRender, width: '123',render_header: true},
          { type: 'array', prop: 'process_tags', label: '事项标签', render: this.tagRender, width: '123',render_header: true},
          { type: 'text', prop: 'application_number', label: '申请号', render_header: true, width: '110',},
          { type: 'text', prop: 'application_date', label: '申请日', render_header: true, width: '100',},
          ...
          { type: 'text', prop: 'final_reviewer', label: '复审人', render_simple: 'name', render_header: true, width: '110',},
          { type: 'text', prop: 'organization_unit', label: '所属部门', render_obj: 'project', render_simple: 'name', render_header: true, width: '110',},
          { type: 'text', prop: 'customer', label: '客户', render_obj: 'project', render_simple: 'name', render_header: true, width: '120',},
          { type: 'text', prop: 'ipr', label: 'IPR', render_obj: 'project', render_simple: 'name', render_header: true, width: '110',},
          { type: 'text', prop: 'contact', label: '联系人', render_obj: 'project', render_simple: 'name', render_header: true, width: '100',},
          { type: 'text', prop: 'first_edition_deadline', label: '初稿期限', render_header: true, width: '100',},
          { type: 'text', prop: 'filing_deadline', label: '递交期限', render_header: true, width: '100',},
          { type: 'text', prop: 'legal_deadline', label: '官方绝限', render_header: true, width: '100',},
          { type: 'text', prop: 'first_edition_time', label: '初稿日', render_header: true, width: '100',},
          { type: 'text', prop: 'internal_final_edition_time', label: '内部定稿日', render_header: true, width: '110',},
          { type: 'text', prop: 'customer_edition_time', label: '返稿日', render_header: true, width: '100',},
          { type: 'text', prop: 'customer_final_edition_time', label: '客户定稿日', render_header: true, width: '110',},
          { type: 'text', prop: 'filing_time', label: '递交日', render_header: true, width: '100',},
          { type: 'text', prop: 'internal_drafting_period', label: '内撰时长', render_header: true, width: '100',},
          { type: 'text', prop: 'internal_amending_period', label: '内改时长', render_header: true, width: '100',},
          { type: 'text', prop: 'internal_reviewing_period', label: '内审时长', render_header: true, width: '100',},
          { type: 'text', prop: 'customer_first_edition_period', label: '返稿时长', render_header: true, width: '100',},
          { type: 'text', prop: 'customer_reviewing_period', label: '客审时长', render_header: true, width: '100',},
          { type: 'text', prop: 'customer_amending_period', label: '客改时长', render_header: true, width: '100',},
          { type: 'text', prop: 'internal_reviewing_times', label: '内审次数', render_header: true, width: '100',},
          { type: 'text', prop: 'customer_reviewing_times', label: '客审次数', render_header: true, width: '100',},
          { type: 'text', prop: 'technical_rank', label: '技术评分', render_header: true, width: '100',},
          { type: 'text', prop: 'claims_rank', label: '权要评分', render_header: true, width: '100',},
