    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', prop: 'organization_unit', label: '所属部门', render_simple: 'name', render_header: true, width: '110',},
          { type: 'text', prop: 'customer', label: '客户', render_simple: 'name', render_header: true, width: '120',},
          { type: 'text', prop: 'ipr', label: 'IPR', render_simple: 'name', render_header: true, width: '110',},
          { type: 'text', prop: 'contact', label: '联系人', render_simple: 'name', render_header: true, width: '100',},
