    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', prop: 'first_reviewer', label: '初审核人', render_simple: 'name', render_header: true, width: '145',},
          { type: 'text', prop: 'final_reviewer', label: '复审人', render_simple: 'name', render_header: true, width: '145',},
          { type: 'text', prop: 'organization_unit', label: '所属部门', render_obj: 'project', render_simple: 'name', render_header: true, width: '160',},
          { type: 'text', prop: 'customer', label: '客户', render_obj: 'project', render_simple: 'name', render_header: true, width: '145',},
          { type: 'text', prop: 'ipr', label: 'IPR', render_obj: 'project', render_simple: 'name', render_header: true, width: '145',},
          { type: 'text', prop: 'contact', label: '联系人', render_obj: 'project', render_simple: 'name', render_header: true, width: '145',},          
