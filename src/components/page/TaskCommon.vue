    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', label: '管制事项开始', prop: 'process_start_time', show: true, sortable: true, width: '150'},
          { type: 'text', label: '管制事项期限', prop: 'process_inner_deadline', show: true, sortable: true, width: '150'},
          { type: 'text', label: '官方绝限', prop: 'deadline', show: true, sortable: true, width: '118'},
          { type: 'text', label: '节点开始时间', prop: 'start_time', show: true, sortable: true, width: '150'},
          { type: 'text', label: '节点期限', prop: 'due_time', show: true, sortable: true, width: '118'},
          { type: 'text', label: '返稿日', prop: 'first_edition_time', show: true, sortable: true, width: '118'},
          { type: 'text', label: '节点超期天数', prop: 'duetime_days', show: true, sortable: true, width: '150'},
          { type: 'text', label: '管制事项超期天数', prop: 'process_duetime_days', show: true, sortable: true, width: '170'},
