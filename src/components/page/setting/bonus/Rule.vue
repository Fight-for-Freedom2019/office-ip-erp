            ...
            return {
                ...
                tableOption: {
                    ...
                    'columns': [
                        ...
                        {type: 'text', label: '管制事项', prop: 'process_definition',render_simple:'name', width: '120'},
                        ...
                        {type: 'text', label: '客户', prop: 'customer',render_simple:'name', width: '100'},
                        ...
                        {type: 'text', label: '流程节点', prop: 'process_action',render_simple:'name', width: '120'},
                        {type: 'text', label: '是否折扣', prop: 'is_discount',width: '100', render: (h, item) => h('span', item ? '是' : '否')},
