        ...
        return {
            tableOption: {
                ...
                columns: [
                    ...
                    { type: "text", label: "金额", prop: "amount", width: "90", align: "right", render: this.formatMoney},
                    { type: "text", label: "币别", prop: "currency", width: "55" },
                    { type: "text", label: "汇率", prop: "roe", width: "68", align: "right" },
                    { type: "text", label: "人民币", prop: "rmb_amount", width: "90", align: "right", render: this.formatMoney },
