  ...
  <div class="Panel">
    <app-shrink :visible.sync="isApplicationEditor" :title="title" size="full-screen">
      ...
      <el-dialog :visible.sync="showTurnArchives" :modal="false" top="8vh">
        ...
        <turn-archives @hide="hideTurnArchives" :otherFormMap="otherFormMap" :amendments="amendments"
                       @getTurnArchives="getTurnArchives"></turn-archives>
      </el-dialog>
      <!-- 转档 end -->
    </app-shrink>
  </div>
  ...
  export default {
    ...
    methods: {
      ...
      openForm(id, index, isRemove = false) {
        ...
        this.$f?this.$f.validate(this.successValidate(isRemove), this.errorValidate):"";
