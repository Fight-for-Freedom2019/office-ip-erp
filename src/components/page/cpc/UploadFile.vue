            ...
            <el-form :model="fileTypeForm" label-position="top" ref="fileTypeForm" :rules="rule">
                <el-form-item prop="fileType" label="请选择文件类型">
                    <el-select value-key="id" v-model="fileTypeForm.fileType">
                        <el-option v-for="item in fileTypeList"
                                   :value="item.value"
                                   :label="item.label"
                                   :key="item.value"
                        ></el-option>
    ...
    export default {
        ...
        computed: {
            fileTypeList: function () {
                ...
                if (this.type === "design") {
                    options = [
                        {value: 130001.1, label: "主视图"}, {value: 130001.2, label: "后视图"}, {
                            value: 130001.3,
                            label: "左视图"
                        }, {value: 130001.4, label: "右视图"}, {value: 1300015, label: "俯视图"}, {
                            value: 1300016,
                            label: "仰视图"
                        }, {value: 1300017, label: "立体图"}, {value: 1300018, label: "使用状态参考图"}, {
                            value: 130002,
                            label: "简要说明"
                    ...
                    if (this.patent_type === 1 || this.patent_type === 4) {
                        options = options.concat([{value: 100120, label: "生物材料保藏证明"}, {
                            value: 100111,
                            label: "生物材料存活证明"
                        }, {
                            value: 100112,
        ...
        methods: {
            ...
            handleFileUploadSuccess(r, f, fl) {
                ...
                if (this.fileSuccessCount === this.fileCount) {
                    this.userDefined ? this.fileTypeForm.fileType = this.fileTypeList[0].value : "";
            ...
            saveCpcFile() {
                ...
                this.fileList.some((item) => {
                    ...
                    temp.push({
                        name: this.userDefined && this.fileTypeForm.fileTypeInput !== "" ? this.fileTypeForm.fileTypeInput : item.type,
