    ...
    <el-form :model="form" label-width="100%" label-position="top">
        <el-form-item label="第一步">
            <el-upload
                ...
                <div slot="tip" class="el-upload__tip">上传专利说明书（仅支持.doc/.docx格式）</div>
            </el-upload>
        </el-form-item>
    ...
    export default {
        ...
        data(){
            return {
                ...
                defeated:"转档失败，一般是由于系统无法识别说明书的章节，请使用系统推荐模板撰写说明书",
                tableOption: {
                    ...
                    'list_type': 'serial',
                    'columns': [
                        {type: 'text', label: '文件名称', prop: 'filename', min_width: '150'},
                        {type: 'text', label: '起始页码', prop: 'begin', width: '100'},
                        {type: 'text', label: '页数', prop: 'project_subtype', width: '120'},
