    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', label: '事务所案号', prop: 'agency_serial', is_agency: true, sortable: true, width: '150', render_header: true },
          { type: 'text', label: '案件名称', prop: 'title', sortable: true, is_import: true, width: '200', is_agency: true, render_header: true},
          ...
          { type: 'text', label: '法律状态', prop: 'legal_status', sortable: true, width: '180', is_agency: true, render_simple: 'name', render_header: true},
          ...
          { type: 'text', label: '专利摘要', prop: 'abstract', sortable: true, width: '200', render_header: true},
          { type: 'text', label: '公开日', prop: 'public_date', sortable: true, is_import: true, width: '110', show: false, render_header: true},
          { type: 'text', label: '公开号', prop: 'public_number', sortable: true, is_import: true, width: '110', show: false, render_header: true},
          { type: 'text', label: '初审合格日', prop: 'pre_exam_ok_date', sortable: true, width: '140', show: false, render_header: true},
          { type: 'text', label: '进入实审日', prop: 'sub_exam_start_date', sortable: true, width: '140', show: false, render_header: true},
          { type: 'text', label: '公告日', prop: 'issue_date', sortable: true, is_import: true, width: '110', show: false, render_header: true},
          { type: 'text', label: '公告号', prop: 'issue_number', sortable: true, is_import: true, width: '110', show: false, render_header: true},
          { type: 'text', label: '主国际分类号', prop: 'main_ipc', sortable: true, width: '160', show: false, render_header: true},
          { type: 'text', label: '国际申请日', prop: 'pct_apd', sortable: true, width: '140', show: false, render_header: true},
          { type: 'text', label: '国际申请号', prop: 'pct_no', sortable: true, width: '140', show: false, render_header: true},
          { type: 'text', label: '国际优先权日', prop: 'pct_priority_date', sortable: true, width: '160', show: false, render_header: true},
          { type: 'text', label: '国际公开日', prop: 'pct_public_date', sortable: true, width: '140', show: false, render_header: true},
          { type: 'text', label: '国际公开语言', prop: 'pct_public_language', sortable: true, width: '160', show: false, render_header: true},
          { type: 'text', label: '国际公开号', prop: 'pct_public_no', sortable: true, width: '140', show: false, render_header: true},
          ...
          { type: 'text', label: '技术分类', width: '123' , prop: 'classification', sortable: true, is_import: true, render_simple: 'name',render_header: true},
          ...
          { type: 'text', label: '委案时间', prop: 'entrusting_time',  render_header: true, is_import: true, width: '123',         
            render: (h,item)=>{
              let t = item;
              if(t) {
          ...
          { type: 'text', label: '立案时间', prop: 'create_time', sortable: true, width: '145'  , render_header: true},
          { type: 'text', label: 'DAS码', prop: 'das', sortable: true, width: '145' , render_header: true },
          { type: 'text', label: '专利族号', prop: 'family_number', sortable: true, width: '145'  , render_header: true},
          { type: 'text', label: '群组号', prop: 'group_number', sortable: true, width: '145' , render_header: true },
          { type: 'text', label: 'IPR审核次数', prop: 'ipr_review_times', sortable: true, width: '145'  , render_header: true},
          { type: 'text', label: 'PCT19条修改期限', prop: 'pct_19_expire_date', sortable: true, width: '198'  , render_header: true},
          { type: 'text', label: 'PCT进入国家阶段期限', prop: 'pct_national_stage_expire_date', sortable: true, width: '198'  , render_header: true},
          { type: 'text', label: 'PCT国际初步审查期限', prop: 'pct_pre_exam_expire_date', sortable: true, width: '198' , render_header: true },
          { type: 'text', label: '国际检索日期', prop: 'pct_search_date', sortable: true, width: '145'  , render_header: true},
          { type: 'text', label: '优先权届满期限', prop: 'priority_expire_date', sortable: true, width: '178'  , render_header: true},
          { type: 'text', label: '项目名称', prop: 'project_name', sortable: true, width: '145'  , render_header: true},
          { type: 'text', label: '项目编号', prop: 'project_serial', sortable: true, width: '145' , render_header: true },
          { type: 'text', label: '提案标题', prop: 'proposal_title', sortable: true, width: '145'  , render_header: true},
          { type: 'text', label: '首次年费年度', prop: 'start_year', sortable: true, width: '145'  , render_header: true},
          // { type: 'text', label: '详细类型', prop: 'type_name', sortable: true, width: '145' },
          { type: 'text', label: '是否变更', prop: 'is_amended', sortable: true, width: '178',show: false, render:this.booleanRender , render_header: true},         
          ...
          { type: 'text', label: '是否保密审查', prop: 'is_secure_check', sortable: true, width: '145',show: false,render:this.booleanRender , render_header: true},         
