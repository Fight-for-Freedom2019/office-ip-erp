            ...
            return {
                ...
                tableOption: {
                    ...
                    'columns': [
                        ...
                        {type: 'text', label: '案件类型', prop: 'project_type',render_simple:'name', width: '100', render_header: true},
                        {type: 'text', label: '案件子类型', prop: 'subtype',render_simple:'name', width: '120', render_header: true},
                        ...
                        {type: 'text', label: '提成类型', prop: 'bonus_type',render_simple:'name', width: '100', render_header: true},
                        {type: 'text', label: '用户', prop: 'user',render_simple:'name', width: '100', render_header: true},
                        ...
                        {type: 'text', label: '状态', prop: 'status',render_simple:'name', width: '120', render_header: true},
